ROOMS = {
    ...
    'garden': {
        'description': 'Тайный сад с волшебными растениями. В центре растет сияющий цветок.',
        'exits': {'north': 'library'},
        'items': ['magic_flower', 'healing_potion'],
        'puzzle': ('Цветок говорит: "Я легче пера, но сильнее стали. Что я?"', 'дыхание')
    },
    'forge': {
        'description': 'Кузница с раскаленными углями. На наковальне лежит незаконченный меч.',
        'exits': {'west': 'trap_room'},
        'items': ['hammer', 'unfinished_sword'],
        'puzzle': ('На стене написано: "Что можно сломать, даже если никогда не брать в руки?"', 'обещание')
    }
}